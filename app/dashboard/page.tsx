...
export default function DashboardPage() {
  const powerBiUrl =
    "https://app.powerbi.com/view?r=eyJrIjoiNGY4MGRlNWEtNDY3MC00NTJhLTg0NDItYWY2YmQzMzI4NTg1IiwidCI6IjFmNDM2ODQxLWZkMzEtNGFhYy1iNDkyLTlkMWI2OTJjMTU3YiIsImMiOjEwfQ%3D%3D";
          ...
          <div className="flex flex-col gap-3">
            <div>
              ...
              <p className="text-base md:text-lg text-muted-foreground mt-3 leading-relaxed">
                Real-time insights into community engagement projects led by GIM
                students
              </p>
            </div>
            <p className="text-sm md:text-base text-muted-foreground max-w-4xl leading-relaxed">
              This dashboard provides real-time analytics on student initiatives
              contributing to sustainable development across Goa and beyond.
              Data is updated automatically from the GiveGoa repository.
            </p>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 md:px-6 lg:px-8 py-8 md:py-10">
        <Card className="mb-8">
          <CardHeader className="pb-6">
            ...
            <CardDescription className="text-base">
              Interactive dashboard with real-time project insights and
              analytics
            </CardDescription>
          </CardHeader>
        ...
        <div className="mt-8 p-5 bg-muted/50 rounded-lg border">
          <p className="text-sm text-muted-foreground text-center flex items-center justify-center gap-2">
            ...
            <span>
              Dashboard updated in real-time | Data sourced from GiveGoa
              Repository
            </span>
          </p>
        </div>
